...
public class Child extends Person {
	...
	private ArrayList<Person> parents = new ArrayList<>(); // ArrayList holding childs parents
	
	/**
	 * This method is the class constructor inherited from the Person superclass
	 */
	public Child(String userID, String fullName, int age, String gender, String photo, String status) {
